              ...
              <div className="instruction mt-5">
                ...
                <div className="mt-3">
                  ...
                  <p className=" contentsection mt-2">
                    ...
                    (Mastercard/Visa Card) or Bank accounts if products are
                    faulty (badly damaged, incorrect textures with confirmation
                    before shipping, etc) by our company.
                  </p>
                </div>
              </div>
            </div>
