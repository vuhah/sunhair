            ...
            <div className="container-fluid pt-5">
              <div className="row d-flex justify-content-between">
                <div className="col-6">
                  ...
                  <div className="mt-5">
                    <img src={WAIcon} className="icon ps-2 me-3" />
                    <span className="icon"> https://wa.me/84912124125</span>
                  </div>
  
                  <div className="mt-5">
                    <img src={PhoneIcon} className="icon ps-2 me-3 " />
                    <span className="icon "> (+84) 969-682-226 </span>
                  </div>
  
                  <div className="mt-5">
                    <img src={EmailIcon} className="icon ps-2 me-3" />
                    <span className="icon mt-4"> Sunhaircompany@gmail.com</span>
                  </div> 
  
                  <div className="mt-5">
                    <img src={Location} className="icon ps-2 me-3" />
